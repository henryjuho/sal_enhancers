...
mles$region <- factor(mles$region, levels=rev(c('all-enhancers', 'intergenic-enhancers', 'intergenic', 'intron-enhancers', 'intron','utr-enhancers',  'utr', 'cds-enhancers', 'cds', '0fold-enhancers', '0fold')))
levels(mles$region) <- rev(c( 'H3K27ac peaks (all)', 'H3K27ac peaks (intergenic)', 'intergenic', 'H3K27ac peaks (intron)', 'intron', 'H3K27ac peaks (UTR)', 'UTR', 'H3K27ac peaks (CDS)', 'CDS', 'H3K27ac peaks (0fold)', '0fold degenerate'))
